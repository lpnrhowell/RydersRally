					...
					{data.getEvents &&
						data.getEvents.map((event) => (
							<div className='event'>
								...
								<Grid.Column id='eventInfo'>{event.venue}</Grid.Column>
								<Grid.Column id='eventInfo'>{event.city_state}</Grid.Column>
								<Grid.Column id='eventInfo'>🎟 {event.ticket_price}</Grid.Column>
							</div>
						))}
				</Transition.Group>
				// </div>
